...
games = read.csv("/Users/Nick/Documents/MarchMadness/regular_season_results.csv")
teams = read.csv("/Users/Nick/Documents/MarchMadness/teams.csv")
...
t4 = read.csv("/Users/Nick/Documents/MarchMadness/sample_submission.csv")
...
write.csv(t6, file="/Users/Nick/Documents/MarchMadness/submit_0127LS.csv", row.names=F)
